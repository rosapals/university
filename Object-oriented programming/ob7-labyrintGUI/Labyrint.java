...
// en rute i labyrinten beskrives på formen (kol, rad)
public class Labyrint {
    ...
    private void registrerNaboer() {
        // hver rute har referanse til alle sine naboruter
        int kol, rad;
    ...
    public ArrayList<ArrayList<Rute>> hentRutenett() {
        return rutenett;
    }
    ...
    public String toString() {
        // visualiser labyrinten ved testing
        String rutenett = "";
    ...
    public String toStringKoordinat() {
        // for aa faa oversikt over koordinatene ved testing
        String rutenett = "";
        for (ArrayList<Rute> rad : hentRutenett()){
            for (Rute rute : rad){
                rutenett += rute;
